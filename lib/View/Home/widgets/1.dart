  ...
  static List<Travel> getTravelItems() {
    final List<Travel> _travelList = [
      Travel(
          ...
          4.6,
          3,
          [Assets.images1mus, Assets.imagesThumbnail1],
          230),
      Travel(
          'Dubai Burg',
          5,
          ...
          4.3,
          6,
          [Assets.images2mus, Assets.imagesThumbnail2],
          432),
      Travel(
          'Arc Bridge',
          3,
          ...
          4.5,
          8,
          [Assets.images5mus, Assets.imagesThumbnail3],
          283),
      Travel(
          'Magic Beaches',
          3,
          ...
          4.2,
          16,
          [Assets.images4mus, Assets.imagesThumbnail4],
          389),
      Travel(
          'Blue Nature',
          2,
          ...
          4.8,
          21,
          [Assets.images9mus, Assets.imagesThumbnail5],
          534),
    ];
    return _travelList;
  }
